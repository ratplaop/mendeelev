...
etX = galleryPos.x + (releaseSpeed * 20);
    ...
    function startAutoScroll() {
        autoScrollInterval = setInterval(function() {
            var nextImage = (currentImage + 1) % $galleryPicture.length;
            setGalleryPos(nextImage);
        }, 5000); // Переход к следующему изображению каждые 5 секунд
    }
    ...
    // Начинаем автоперенос
    startAutoScroll();

    // Останавливаем автоперенос при взаимодействии с галереей
